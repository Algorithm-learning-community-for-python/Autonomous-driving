...
class Agent(object):
    ...
    def custom_is_light_red(self):
        # Checking if there is a red traffic_light within 20 meters ahead
        look_ahead_threshold = 20
        ...
        if traffic_light is not None:
            ...
            if is_within_distance_ahead(
                    ...
                    look_ahead_threshold): # Distanse to look ahead):
    ...
    def _is_vehicle_hazard(self, vehicle_list):
        ...
        for target_vehicle in vehicle_list:
            ...
            if is_within_distance_ahead(loc, ego_vehicle_location,
                ...
                return (True, target_vehicle, 10)
            
            if closest != 15 and is_within_distance_ahead(loc, ego_vehicle_location,
                                        self._vehicle.get_transform().rotation.yaw,
                                        15):
                closest_vehicle = target_vehicle
                closest = 15
            
            if closest == -1 and is_within_distance_ahead(loc, ego_vehicle_location,
                                        self._vehicle.get_transform().rotation.yaw,
                                        20):
                closest_vehicle = target_vehicle
                closest = 20
        ...
        if closest != -1:
            return (True, closest_vehicle, closest)
